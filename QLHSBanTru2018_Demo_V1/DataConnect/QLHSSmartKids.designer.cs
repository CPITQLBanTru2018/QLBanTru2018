...
namespace DataConnect
{
    ...
    partial void DeleteWeeklyMenu(WeeklyMenu instance);
		...
		public QLHSSmartKidsDataContext() : 
				base(global::DataConnect.Properties.Settings.Default.CPITQLHSBanTruConnectionString2, mappingSource)
		{
			OnCreated();
		}
    ...
    partial void OnStatusChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Employee_Class", Storage="_Employee", ThisKey="EmployeeID", OtherKey="EmployeeID", IsForeignKey=true)]
    ...
    partial void OnStatusChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_WeeklyTaskID", AutoSync=AutoSync.OnInsert, DbType="Int NOT NULL IDENTITY", IsPrimaryKey=true, IsDbGenerated=true)]
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="WeeklyTask_DailyTask", Storage="_DailyTasks", ThisKey="WeeklyTaskID", OtherKey="WeeklyTaskID")]
    ...
    partial void OnStatusChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Meal_DailyMenuDetail", Storage="_Meal", ThisKey="MealID", OtherKey="MealID", IsForeignKey=true)]
		public Meal Meal
		{
			get
			{
	...
	public partial class DailyTask : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private EntityRef<PhysicalMonthlyTask> _PhysicalMonthlyTask;
    ...
    partial void OnStatusChanged();
		...
		public DailyTask()
		{
			this._WeeklyTask = default(EntityRef<WeeklyTask>);
			this._PhysicalMonthlyTask = default(EntityRef<PhysicalMonthlyTask>);
			this._Student = default(EntityRef<Student>);
			OnCreated();
		}
		...
		public int WeeklyTaskID
		{
			...
			set
			{
				if ((this._WeeklyTaskID != value))
				{
					if (this._WeeklyTask.HasLoadedOrAssignedValue)
					{
						throw new System.Data.Linq.ForeignKeyReferenceAlreadyHasValueException();
					}
					this.OnWeeklyTaskIDChanging(value);
		...
		public int MonthlyTaskID
		{
			...
			set
			{
				...
				{
					if (this._PhysicalMonthlyTask.HasLoadedOrAssignedValue)
					{
						throw new System.Data.Linq.ForeignKeyReferenceAlreadyHasValueException();
					}
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="WeeklyTask_DailyTask", Storage="_WeeklyTask", ThisKey="WeeklyTaskID", OtherKey="WeeklyTaskID", IsForeignKey=true)]
		public WeeklyTask WeeklyTask
		{
			get
			{
				return this._WeeklyTask.Entity;
			}
			set
			{
				WeeklyTask previousValue = this._WeeklyTask.Entity;
				if (((previousValue != value) 
							|| (this._WeeklyTask.HasLoadedOrAssignedValue == false)))
				{
					this.SendPropertyChanging();
					if ((previousValue != null))
					{
						this._WeeklyTask.Entity = null;
						previousValue.DailyTasks.Remove(this);
					}
					this._WeeklyTask.Entity = value;
					if ((value != null))
					{
						value.DailyTasks.Add(this);
						this._WeeklyTaskID = value.WeeklyTaskID;
					}
					else
					{
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="PhysicalMonthlyTask_DailyTask", Storage="_PhysicalMonthlyTask", ThisKey="MonthlyTaskID", OtherKey="PhysicalMonthlyTaskID", IsForeignKey=true)]
		public PhysicalMonthlyTask PhysicalMonthlyTask
		{
			get
			{
				return this._PhysicalMonthlyTask.Entity;
			}
			set
			{
				PhysicalMonthlyTask previousValue = this._PhysicalMonthlyTask.Entity;
				if (((previousValue != value) 
							|| (this._PhysicalMonthlyTask.HasLoadedOrAssignedValue == false)))
				{
					this.SendPropertyChanging();
					if ((previousValue != null))
					{
						this._PhysicalMonthlyTask.Entity = null;
						previousValue.DailyTasks.Remove(this);
					}
					this._PhysicalMonthlyTask.Entity = value;
					if ((value != null))
					{
						value.DailyTasks.Add(this);
						this._MonthlyTaskID = value.PhysicalMonthlyTaskID;
					}
					else
					{
    ...
    partial void OnStatusChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Employee_Class", Storage="_Classes", ThisKey="EmployeeID", OtherKey="EmployeeID")]
    ...
    partial void OnStatusChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_Eyes", DbType="NVarChar(30) NOT NULL", CanBeNull=false)]
		public string Eyes
		{
			get
			{
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_ENT", DbType="NVarChar(30) NOT NULL", CanBeNull=false)]
		public string ENT
		{
			get
			{
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_InternalMedicine", DbType="NVarChar(30) NOT NULL", CanBeNull=false)]
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_Oral", DbType="NVarChar(30) NOT NULL", CanBeNull=false)]
		public string Oral
		{
			get
			{
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_Surgery", DbType="NVarChar(30) NOT NULL", CanBeNull=false)]
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_Dermatology", DbType="NVarChar(30) NOT NULL", CanBeNull=false)]
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_BoneMuscle", DbType="NVarChar(30) NOT NULL", CanBeNull=false)]
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_Nerve", DbType="NVarChar(30) NOT NULL", CanBeNull=false)]
		public string Nerve
		{
			get
			{
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_Endocrine", DbType="NVarChar(30) NOT NULL", CanBeNull=false)]
    ...
    partial void OnStatusChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_QuantityOfUnit", DbType="Float NOT NULL")]
    ...
    partial void OnStatusChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Location_Student", Storage="_Students", ThisKey="LocationID", OtherKey="LocationID")]
    ...
    partial void OnStatusChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Meal_DailyMenuDetail", Storage="_DailyMenuDetails", ThisKey="MealID", OtherKey="MealID")]
		public EntitySet<DailyMenuDetail> DailyMenuDetails
		{
			get
			{
    ...
    partial void OnDateChanging(System.DateTime value);
    partial void OnDateChanged();
    partial void OnEmployeeID1Changing(int value);
    partial void OnEmployeeID1Changed();
    partial void OnEmployeeID2Changing(int value);
    partial void OnEmployeeID2Changed();
    partial void OnEmployeeID3Changing(int value);
    partial void OnEmployeeID3Changed();
    partial void OnStatusChanging(bool value);
    partial void OnStatusChanged();
    #endregion
		...
		public int EmployeeID1
		{
			...
			set
			{
				...
				{
					this.OnEmployeeID1Changing(value);
					this.SendPropertyChanging();
					this._EmployeeID1 = value;
					this.SendPropertyChanged("EmployeeID1");
					this.OnEmployeeID1Changed();
				}
			}
		}
		
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_EmployeeID2", DbType="Int NOT NULL")]
		public int EmployeeID2
		{
			...
			set
			{
				if ((this._EmployeeID2 != value))
				{
					...
					this.SendPropertyChanged("EmployeeID2");
					this.OnEmployeeID2Changed();
				}
			}
		}
		
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_EmployeeID3", DbType="Int NOT NULL")]
		public int EmployeeID3
		{
			get
			{
				return this._EmployeeID3;
			}
			set
			{
				if ((this._EmployeeID3 != value))
				{
					this.OnEmployeeID3Changing(value);
					this.SendPropertyChanging();
					this._EmployeeID3 = value;
					this.SendPropertyChanged("EmployeeID3");
					this.OnEmployeeID3Changed();
				}
			}
		}
    ...
    partial void OnStatusChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="PhysicalMonthlyTask_DailyTask", Storage="_DailyTasks", ThisKey="PhysicalMonthlyTaskID", OtherKey="MonthlyTaskID")]
		public EntitySet<DailyTask> DailyTasks
		{
			get
			{
		...
		{
			this.SendPropertyChanging();
			entity.PhysicalMonthlyTask = this;
		}
		
		private void detach_DailyTasks(DailyTask entity)
		{
			this.SendPropertyChanging();
			entity.PhysicalMonthlyTask = null;
		}
	}
    ...
    partial void OnStatusChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Location_Student", Storage="_Location", ThisKey="LocationID", OtherKey="LocationID", IsForeignKey=true)]
		public Location Location
		{
			get
			{
	...
	public partial class StudentParent : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private System.DateTime _FatherBirthday;
		...
		private System.DateTime _MotherBirthday;
    ...
    partial void OnFatherBirthdayChanging(System.DateTime value);
    ...
    partial void OnMotherBirthdayChanging(System.DateTime value);
    ...
    partial void OnMotherJobChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_FatherName", DbType="NVarChar(40) NOT NULL", CanBeNull=false)]
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_FatherBirthday", DbType="Date NOT NULL")]
		public System.DateTime FatherBirthday
		{
			get
			{
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_FatherPhone", DbType="VarChar(15) NOT NULL", CanBeNull=false)]
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_FatherJob", DbType="NVarChar(50) NOT NULL", CanBeNull=false)]
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_MotherName", DbType="NVarChar(40) NOT NULL", CanBeNull=false)]
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_MotherBirthday", DbType="Date NOT NULL")]
		public System.DateTime MotherBirthday
		{
			get
			{
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_MotherPhone", DbType="VarChar(15) NOT NULL", CanBeNull=false)]
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_MotherJob", DbType="NVarChar(50) NOT NULL", CanBeNull=false)]
